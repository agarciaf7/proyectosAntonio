...
# USAGE
# python face-tracking2.py --video face_tracking_example.mp4
# python face-tracking2.py --picamera 1 si es con picamera
# python face-tracking3.py si es con una webcam normal
